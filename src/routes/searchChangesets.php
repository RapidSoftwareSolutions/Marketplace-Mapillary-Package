<?php
$app->post('/api/Mapillary/searchChangesets', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "changesets";
    $body = array();
    ...
    if (isset($post_data['args']['types']) && strlen($post_data['args']['types']) > 0){
        $body['types'] = $post_data['args']['types'];
    }
